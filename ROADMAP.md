...
| 8 | `800-add-framework-docs` | Documentation : créateur (Studio MCP, modes système), développeur (architecture moteur, orchestrateur, MCP, capteurs), mainteneur (référence fonctionnelle exhaustive) | — |
