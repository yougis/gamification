...
- [ ] 6.4 Tester l'installation sur iPhone 12 physique (via TestFlight ou Xcode) — Vérifier : l'app s'installe et se lance — NOTE 2026-09-22 : voie retenue = Xcode direct (Mac + Apple ID gratuit, câble) ; certificat perso 7 jours → re-installation hebdomadaire
- [ ] 6.5 Prérequis distribution iOS : enrôlement Apple Developer + groupe de testeurs internes TestFlight — Vérifier : le build 6.3 est visible dans App Store Connect et distribué au groupe interne — NOTE 2026-09-22 : NON REQUIS pour la phase de test (décision : Apple ID gratuit + Xcode direct) ; réactiver pour la production (App Store)
